...
}) => RustLib.instance.api.crateApiPeerRtcRtpTransceiverAddTransceiver(
  peer: peer,
  mediaType: mediaType,
  init: init,
);
...
Future<List<RtcRtpTransceiver>> getTransceivers({
  required ArcPeerConnection peer,
}) => RustLib.instance.api.crateApiPeerRtcRtpTransceiverGetTransceivers(
  peer: peer,
);
...
}) => RustLib.instance.api.crateApiPeerRtcRtpTransceiverSetTransceiverDirection(
...
Future<void> setTransceiverRecv({
  required ArcRtpTransceiver transceiver,
  required bool recv,
}) => RustLib.instance.api.crateApiPeerRtcRtpTransceiverSetTransceiverRecv(
  transceiver: transceiver,
  recv: recv,
);
...
Future<void> setTransceiverSend({
  required ArcRtpTransceiver transceiver,
  required bool send,
}) => RustLib.instance.api.crateApiPeerRtcRtpTransceiverSetTransceiverSend(
  transceiver: transceiver,
  send: send,
);
...
Future<String?> getTransceiverMid({required ArcRtpTransceiver transceiver}) =>
    RustLib.instance.api.crateApiPeerRtcRtpTransceiverGetTransceiverMid(
      transceiver: transceiver,
    );
...
Future<RtpTransceiverDirection> getTransceiverDirection({
  required ArcRtpTransceiver transceiver,
}) => RustLib.instance.api.crateApiPeerRtcRtpTransceiverGetTransceiverDirection(
  transceiver: transceiver,
);
...
Future<void> stopTransceiver({required ArcRtpTransceiver transceiver}) =>
    RustLib.instance.api.crateApiPeerRtcRtpTransceiverStopTransceiver(
      transceiver: transceiver,
    );
