...
enum class SessionDescriptionType(val value: Int) {
    /**
     * Indicates that the description is the initial proposal in an offer/answer
     * exchange.
     */
    OFFER(0),
    ...
    /**
     * Indicates that the description is the definitive choice in an
     * offer/answer exchange.
     */
    ANSWER(2),

    /**
     * Indicates that the description rolls back from an offer/answer state to
    ...
    companion object {
        ...
        /**
         * Tries to create a [SessionDescriptionType] based on the provided
         * [Int].
         *
         * @param value  [Int] value from which a [SessionDescriptionType] will
         *               be created.
         *
    ...
    /**
     * Converts this [SessionDescriptionType] into an
     * [org.webrtc.SessionDescription.Type].
     *
     * @return  [org.webrtc.SessionDescription.Type] based on this
...
data class SessionDescription(
    ...
    companion object {
        /**
         * Converts the provided [org.webrtc.SessionDescription] into a
         * [SessionDescription].
         *
         * @return  [SessionDescription] created based on the provided
        ...
        /**
         * Creates a new [SessionDescription] object based on the method call
    ...
    /**
     * Converts this [SessionDescription] into an
     * [org.webrtc.SessionDescription].
     *
     * @return  [org.webrtc.SessionDescription] created based on this
     *          [SessionDescription].
     */
    ...
    /**
     * Converts this [SessionDescription] into a [Map] which can be returned to
     * the Flutter side.
     */
