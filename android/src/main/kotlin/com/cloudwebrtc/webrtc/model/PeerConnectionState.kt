...
enum class PeerConnectionState(val value: Int) {
    /**
     * Indicates that any of the ICE transports or DTLS transports are in the
     * "new" state and none of the transports are in the "connecting",
    ...
    /**
     * Indicates that all the ICE transports and DTLS transports are in the
     * "connected", "completed" or "closed" state, and at least one of them is
     * in the "connected" or "completed" state.
     */
    CONNECTED(2),

    /**
     * Indicates that any of the ICE transports or DTLS transports are in the
     * "disconnected" state, and none of them are in the "failed", "connecting"
     * or "checking" state.
     */
    DISCONNECTED(3),
    ...
    companion object {
        /**
         * Converts the provided [org.webrtc.PeerConnection.PeerConnectionState]
         * into a [PeerConnectionState].
         *
