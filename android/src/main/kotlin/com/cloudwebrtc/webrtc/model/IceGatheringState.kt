...
enum class IceGatheringState(val value: Int) {
     ...
     * requires collecting new candidates, such as a new interface being added
     * or the addition of a new ICE server, the state will revert to `GATHERING`
     * to gather those candidates.
     */
    COMPLETE(2);

    companion object {
        /**
         * Converts the provided [org.webrtc.PeerConnection.IceGatheringState]
         * into an [IceGatheringState].
         *
