...
enum class SignalingState(val value: Int) {
    ...
    /**
     * Indicates that the local peer has called
     * `RTCPeerConnection.setLocalDescription()`.
     */
    HAVE_LOCAL_OFFER(1),

    /**
     * Indicates that the offer sent by the remote peer has been applied and an
     * answer has been created.
     */
    HAVE_LOCAL_PRANSWER(2),

    /**
     * Indicates that the remote peer has created an offer and used the
     * signaling server to deliver it to the local peer, which has set the offer
     * as the remote description by calling
     * `PeerConnection.setRemoteDescription()`.
     */
    HAVE_REMOTE_OFFER(3),

    /**
     * Indicates that the provisional answer has been received and successfully
     * applied in response to the offer previously sent and established.
     */
    ...
    companion object {
        /**
         * Converts the provided [org.webrtc.PeerConnection.SignalingState] into
         * a [SignalingState].
         *
