...
enum class RtpTransceiverDirection(val value: Int) {
    ...
    companion object {
        /**
         * Converts the provided [RtpTransceiver.RtpTransceiverDirection] into
         * an [RtpTransceiverDirection].
         *
        ...
        /**
         * Tries to create an [RtpTransceiverDirection] based on the provided
         * [Int].
         *
         * @param value  [Int] value from which [RtpTransceiverDirection] will
         *               be created.
         *
     ...
     * [RtpTransceiver.RtpTransceiverDirection].
     *
     * @return  [RtpTransceiver.RtpTransceiverDirection] based on this
