...
- (id<RTCI420Buffer>)correctRotation:(const id<RTCI420Buffer>)src
  ...
  I420Rotate(src.dataY, src.strideY, src.dataU, src.strideU, src.dataV, src.strideV,
             (uint8_t*)buffer.dataY, buffer.strideY, (uint8_t*)buffer.dataU, buffer.strideU,
             (uint8_t*)buffer.dataV, buffer.strideV, src.width, src.height,
...
- (void)copyI420ToCVPixelBuffer:(CVPixelBufferRef)outputPixelBuffer
  ...
  if (pixelFormat == kCVPixelFormatType_420YpCbCr8BiPlanarVideoRange ||
    ...
    I420ToNV12(i420Buffer.dataY, i420Buffer.strideY, i420Buffer.dataU, i420Buffer.strideU,
               i420Buffer.dataV, i420Buffer.strideV, dstY, (int)dstYStride, dstUV, (int)dstUVStride,
    ...
    if (pixelFormat == kCVPixelFormatType_32BGRA) {
      ...
      I420ToARGB(i420Buffer.dataY, i420Buffer.strideY, i420Buffer.dataU, i420Buffer.strideU,
                 i420Buffer.dataV, i420Buffer.strideV, dst, (int)bytesPerRow, i420Buffer.width,
                 i420Buffer.height);
    } else if (pixelFormat == kCVPixelFormatType_32ARGB) {
      // Corresponds to libyuv::FOURCC_BGRA
      I420ToBGRA(i420Buffer.dataY, i420Buffer.strideY, i420Buffer.dataU, i420Buffer.strideU,
                 i420Buffer.dataV, i420Buffer.strideV, dst, (int)bytesPerRow, i420Buffer.width,
                 i420Buffer.height);
    }
  }
